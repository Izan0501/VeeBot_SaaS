...
const Privacy = ({ isPublic = true }) => {
    ...
    if (isPublic) {
        return (
            <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-white dark:text-white transition-colors duration-300 font-sans selection:bg-emerald-500 selection:text-white">
                <m.div style={{ scaleX }} className="fixed top-0 left-0 right-0 h-1.5 bg-emerald-500 origin-left z-[60]" />
