...
const categories = ["Todas", "Capacidades", "Entrevistas", "Datos", "Seguridad"];
...
const Faq = ({ isPublic = false }) => {
    ...
    const contentMarkup = (
        <div className={`max-w-5xl mx-auto px-6 ${isPublic ? '' : 'w-full'}`}>
            ...
            {/* FAQ LIST */}
            <m.div layout className="space-y-5 pb-24 relative z-10 max-w-3xl mx-auto">
    ...
    if (isPublic) {
        return (
            <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-white dark:text-white transition-colors duration-500 font-sans selection:bg-indigo-500 selection:text-white overflow-x-hidden relative">
                ...
                <div className="pt-32 relative">
                    ...
                    <div className="absolute top-0 left-0 w-full h-[1200px] overflow-hidden -z-10 pointer-events-none">
                        <div className="absolute top-[-10%] left-[20%] size-[800px] bg-indigo-500/10 rounded-full blur-[120px] mix-blend-multiply dark:mix-blend-screen animate-blob"></div>
                        <div className="absolute top-[10%] right-[10%] size-[600px] bg-purple-500/10 rounded-full blur-[120px] mix-blend-multiply dark:mix-blend-screen animate-blob animation-delay-2000"></div>
                        <div className="absolute top-[40%] left-[30%] size-[600px] bg-pink-500/10 rounded-full blur-[120px] mix-blend-multiply dark:mix-blend-screen animate-blob animation-delay-4000"></div>
                    </div>
    ...
    return (
        <div className="min-h-full bg-slate-50 dark:bg-slate-950 p-6 md:p-10 transition-colors duration-300 relative overflow-hidden">
            <div className="absolute top-0 right-0 size-[600px] bg-indigo-500/5 rounded-full blur-[100px] pointer-events-none"></div>
            {contentMarkup}
        </div>
    );
};
