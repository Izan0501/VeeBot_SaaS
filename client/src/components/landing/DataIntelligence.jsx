...
const DataIntelligence = () => {
  ...
  return (
    <section className="py-20 md:py-32 bg-slate-50 dark:bg-slate-900 relative overflow-hidden transition-colors border-y border-slate-200 dark:border-slate-800">
      ...
      <div className="absolute top-1/2 right-0 -translate-y-1/2 w-[500px] h-[500px] bg-emerald-500/5 dark:bg-emerald-500/10 rounded-full blur-[128px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center lg:text-left order-1">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 dark:text-white mb-6 leading-[1.1] tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500 dark:from-emerald-400 dark:to-teal-300">al orden del Excel.</span>
            </h2>
            ...
            <ul className="space-y-4 mb-10 text-left max-w-md mx-auto lg:mx-0">
              {[
                ...
                >
                  <div className="mt-0.5 w-6 h-6 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center text-emerald-600 dark:text-emerald-400 shrink-0 group-hover:scale-110 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-800 transition-all duration-300">
          ...
          >
            ...
            >
              <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-6 border border-slate-100 dark:border-slate-800 relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-gradient-to-bl from-emerald-500/10 to-transparent rounded-full blur-3xl pointer-events-none"></div>
                  ...
                  {[1, 2, 3].map((row) => (
                    ...
                    >
                      <motion.div
                        ...
                        className="w-10 h-10 rounded-full flex items-center justify-center font-black text-xs shrink-0 shadow-sm bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 transition-colors duration-300"
                      >
                        CV
                      </motion.div>
            ...
            <div className="absolute top-10 -left-4 md:-left-8 w-full h-full bg-slate-200 dark:bg-slate-800 rounded-3xl -z-10 transform -rotate-3 scale-95 opacity-50 border border-slate-300 dark:border-slate-700 transition-transform duration-500 group-hover:rotate-0"></div>
            <div className="absolute top-20 -left-8 md:-left-16 w-full h-full bg-slate-100 dark:bg-slate-900 rounded-3xl -z-20 transform -rotate-6 scale-90 opacity-30 transition-transform duration-500 group-hover:rotate-0"></div>
          </motion.div>
        </motion.div>
      </div>
    </section>
