        ...
        <section ref={containerRef} className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden bg-white dark:bg-slate-950 perspective-[2000px] transition-colors duration-500">
            ...
            */}
            <div className="max-w-7xl mx-auto px-6 relative z-10 pt-32 pb-48 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                ...
                >
                    {/* Badge */}
                    <motion.div variants={itemVariants} className="inline-flex items-center justify-center lg:justify-start mb-6 lg:mb-8 relative group">
                    ...
                    */}
                    <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl md:text-7xl xl:text-8xl font-black text-slate-900 dark:text-white mb-6 lg:mb-8 leading-[1.1] tracking-tight relative z-10 gpu-layer">
                        Contrata talento,<br />
                        <span className="relative inline-block p-2 -m-2">
                            ...
                            <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-fuchsia-600 to-rose-600 dark:from-indigo-400 dark:via-fuchsia-400 dark:to-rose-400 animate-gradient-x font-extrabold">
                                olvida los PDFs.
                            </span>
                        </span>
                    </motion.h1>
                    ...
                    */}
                    <motion.p variants={itemVariants} className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 mb-8 lg:mb-12 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-light">
                    ...
                    <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-5 w-full">
                        ...
                        >
                            ...
                            <div className="relative px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-950 rounded-xl font-black text-lg flex items-center justify-center gap-3 overflow-hidden transition-transform group-hover:scale-[1.02] active:scale-[0.98]">
                                <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/40 to-transparent -translate-x-full group-hover:animate-shine" style={{ animationDuration: '1s' }} />
                    ...
                    */}
                    <motion.div variants={itemVariants} className="mt-10 flex flex-wrap items-center justify-center lg:justify-start gap-4 sm:gap-6 text-sm font-medium text-slate-500 dark:text-slate-400">
                    ...
                    >
                        ...
                        <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ transform: "translateZ(0px)" }}>
                            ...
                            <path
                                ...
                                className="neural-line"
                                style={{ animationDuration: '6s', opacity: 0.6 }}
                            />
                        </svg>

                        {/* --- CENTRO: MOTOR IA --- */}
                        <div
                            className="absolute top-1/3 left-1/3 w-32 h-32 bg-gradient-to-br from-indigo-500 to-purple-600 dark:from-indigo-600 dark:to-purple-600 rounded-[2rem] flex items-center justify-center shadow-2xl shadow-indigo-500/40 dark:shadow-indigo-500/30 z-10"
                        ...
                        {/* --- FRENTE: TARJETA ORDENADA --- */}
                        <motion.div
                            className="absolute top-1/4 right-0 w-80 bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl border border-indigo-100 dark:border-indigo-500/30 rounded-3xl p-6 shadow-2xl shadow-indigo-500/20 dark:shadow-[0_0_50px_-12px_rgba(99,102,241,0.5)] z-20 will-change-transform"
                            style={{ transform: "translateZ(120px) rotateY(-5deg)" }}
                            whileHover={{ scale: 1.02, rotateY: 0, translateZ: "140px" }}
                                ...
                                <div>
                                    ...
                                    <div className="h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                                        <div className="h-full bg-gradient-to-r from-indigo-500 to-fuchsia-500 w-[98%] relative">
                                            <div className="absolute right-0 top-0 h-full w-full bg-gradient-to-r from-transparent to-white/50 animate-[shimmer_2s_infinite]"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-indigo-500/10 dark:bg-indigo-600/20 blur-3xl rounded-full -z-10 pointer-events-none"></div>
                        </motion.div>
                    </motion.div>
                </motion.div>
